...
namespace Project_MVC.Data
{
    public class DbInitializer
    {
        ...
        public static void Initialize(ApplicationDbContext context)
        {
            ...
            string UserRoleConcurrencyStamp = Guid.NewGuid().ToString();
            ...
            var roles = new ApplicationRole[]
            {
                ...
                new ApplicationRole{Id=UserRoleId, Name="User", NormalizedName="USER", ConcurrencyStamp=UserRoleConcurrencyStamp}
            };
